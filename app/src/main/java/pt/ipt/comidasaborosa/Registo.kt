package pt.ipt.comidasaborosa  // Pacote base da aplicação
...
import pt.ipt.comidasaborosa.retrofit.RetrofitHelper  // Inicializador Retrofit
import pt.ipt.comidasaborosa.retrofit.service.SheetyLoginResponse  // Modelo de resposta de login
import pt.ipt.comidasaborosa.retrofit.service.SheetyUserCreatedResponse  // Modelo de resposta de registo
import pt.ipt.comidasaborosa.retrofit.service.UserCreateRequest  // Modelo de pedido de criação de utilizador
import pt.ipt.comidasaborosa.retrofit.service.UserCreateWrapper  // Wrapper para o pedido
import pt.ipt.comidasaborosa.util.ValidationUtils  // Utilitários de validação
