...
object CarrinhoManager {
    ...
    // Notifica os observadores sobre mudanças no carrinho
    private fun notifyChange() {
        _carrinhoChanged.postValue(true)
    }

    // Carrega os itens do carrinho do servidor para o utilizador autenticado
    ...
    // Remove um item do carrinho pelo Menu
